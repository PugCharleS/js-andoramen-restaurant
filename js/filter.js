...
$('#boton-bebidas').click(function (e) {
  ...
  // Itero sobre cada uno de los elementos de todo
  for (const elemento of todo) {
    // Aqui filtro, si la categoria del elemento es igual a bebida, entonces si lo puedo renderizar
...
$('#boton-postres').click(function (e) { 
  ...
  $('#boton-postres').css('background-color', '#eeb243');
   ...
   // Itero sobre cada uno de los elementos de todo
   for (const elemento of todo) {
    // Aqui filtro, si la categoria del elemento es igual a postre, entonces si lo puedo renderizar
